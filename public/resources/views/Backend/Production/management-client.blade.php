                            ...
                            <div class="l-sdb-profile__wrap">
                                <div class="l-sdb-profile__cnt">
                                    <div class="l-sdb-profile__fsection">
                                        <h3 class="c-table-datatables__tle"> Guland Miền Nam đang quản lý <b
                                                class="tle-num-count cnt">{{ $count }}</b> khách hàng</h3>
                                        <hr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="tf-sdb-data-user select" rowspan="1"
                                                                    ...
                                                                    <select class="form-control"
                                                                        ...
                                                                        <option value="1">Khách hàng/Học viên/Cộng tác viên</option>
