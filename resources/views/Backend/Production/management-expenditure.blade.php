...
<script>
            ...
            columns: [
                ...
                { data: 'description',
                    render: function(data, type, row) {
                        ...
                        if (row.avatar) {
                            descAndAvatar = '<a href="#" onclick="previewImage(\'/Assets/Images/Imcomes/' + row.avatar + '\')" class="btn btn-primary">Xem ảnh</a><br>' + row.description;
                        }
    ...
    function previewImage(url) {
        ...
        window.open(url, 'Image', 'width=' + width + ',height=' + height + ',top=' + top + ',left=' + left);
    }
</script>
@endsection
